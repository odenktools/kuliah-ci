...
|
*/
$config['rest_realm'] = 'ODENKTOOLS_API';
...
$config['auth_override_class_method']['user']['generatekey']			= 'none';
...
$config['auth_override_class_method']['user']['userdata'] 				= 'none';
$config['auth_override_class_method']['user']['purchaseable'] 			= 'none';
$config['auth_override_class_method']['user']['registrasi'] 			= 'none';
$config['auth_override_class_method']['user']['generatepasswd'] 		= 'none';
$config['auth_override_class_method']['user']['generateblowfish'] 		= 'none';
...
|
*/
$config['rest_key_name'] = 'X-ODK-KEY';
