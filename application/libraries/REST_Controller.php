...
abstract class REST_Controller extends MY_Controller
{
    ...
    */
	...
	protected function _check_login($username = '', $password = NULL)
	{
		...
		//return $this->ion_auth->login($username, $password, TRUE);
	}
...
//            //return $this->_perform_library_auth($username, $password);
//
//			return $this->tank_auth->login($username, $password, TRUE, TRUE, TRUE);
//        }
//
...
//    }
    ...
    protected function _check_access()
    {
		...
		$this->rest->db->where('controller', $this->getControllerName());
